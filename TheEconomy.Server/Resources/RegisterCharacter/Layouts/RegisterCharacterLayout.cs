...
public class RegisterCharacterLayout(IWorldService worldService, IServerInformation serverInformation, ICorrectTextStrings correctTextStrings, IColors colors) : IRegisterCharacterLayout
{
    public void Create(Player player)
    {
        ...
        dynamic character = RegisterCharacterLayout.GetRandomCharacter();
        ...
        playerTextDraw[7] = worldService.CreatePlayerTextDraw(player, new Vector2(344.000, 148.000), "Nombre");
        ...
        playerTextDraw[9] = worldService.CreatePlayerTextDraw(player, new Vector2(406.000, 148.000), "Apellido");
        ...
        playerTextDraw[18] = worldService.CreatePlayerTextDraw(player, new Vector2(366.000, 208.000), "Estatura");
        ...
        playerTextDraw[28].ForeColor = colors.ObtainRGB("secondaryColor");
        ...
        playerTextDraw[29] = worldService.CreatePlayerTextDraw(player, new Vector2(330.000, 292.000), "Crear");
        ...
        playerTextDraw[29].ForeColor = colors.ObtainRGB("primaryColor");
        ...
        playerTextDraw[31].ForeColor = 255;
    ...
    {
        return player.GetComponent<RegisterCharacterLayoutComponent>() ?? throw new InvalidOperationException($"The '{nameof(RegisterCharacterLayoutComponent)}' component is not attached to the player");
    }
